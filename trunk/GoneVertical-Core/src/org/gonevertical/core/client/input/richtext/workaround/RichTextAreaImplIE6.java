...
public class RichTextAreaImplIE6 extends RichTextAreaImplStandard {
  ...
  public native void initElement() /*-{
    ...
    setTimeout($entry(function() {
      if (_this.@org.gonevertical.core.client.input.richtext.workaround.RichTextAreaImplStandard::initializing == false) {
        return;
      }
      ...
      var elem = _this.@org.gonevertical.core.client.input.richtext.workaround.RichTextAreaImpl::elem;
