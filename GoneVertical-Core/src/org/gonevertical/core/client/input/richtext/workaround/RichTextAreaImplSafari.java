...
public class RichTextAreaImplSafari extends RichTextAreaImplStandard {
  ...
  protected native String getTextImpl() /*-{
    return this.@org.gonevertical.core.client.input.richtext.workaround.RichTextAreaImpl::elem.contentWindow.document.body.innerText;
  }-*/;
  ...
  protected native void setTextImpl(String text) /*-{
    this.@org.gonevertical.core.client.input.richtext.workaround.RichTextAreaImpl::elem.contentWindow.document.body.innerText = text;
  }-*/;
