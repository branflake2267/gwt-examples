...
public abstract class RichTextAreaImplStandard extends RichTextAreaImpl implements
  ...
  public native void initElement()  /*-{
    ...
    // just fine.
    var _this = this;
    _this.@org.gonevertical.core.client.input.richtext.workaround.RichTextAreaImplStandard::onElementInitializing()();
    setTimeout($entry(function() {
      // Turn on design mode.
      _this.@org.gonevertical.core.client.input.richtext.workaround.RichTextAreaImpl::elem.contentWindow.document.designMode = 'On';

      // Send notification that the iframe has reached design mode.
      _this.@org.gonevertical.core.client.input.richtext.workaround.RichTextAreaImplStandard::onElementInitialized()();
    }), 1);
  }-*/;
  ...
  protected native String getHTMLImpl() /*-{
    return this.@org.gonevertical.core.client.input.richtext.workaround.RichTextAreaImpl::elem.contentWindow.document.body.innerHTML;
  }-*/;

  protected native String getTextImpl() /*-{
    return this.@org.gonevertical.core.client.input.richtext.workaround.RichTextAreaImpl::elem.contentWindow.document.body.textContent;
  }-*/;
  ...
  protected native void setFocusImpl(boolean focused) /*-{
   if (focused) {
      this.@org.gonevertical.core.client.input.richtext.workaround.RichTextAreaImpl::elem.contentWindow.focus();
    } else {
      this.@org.gonevertical.core.client.input.richtext.workaround.RichTextAreaImpl::elem.contentWindow.blur();
    }
  }-*/;

  protected native void setHTMLImpl(String html) /*-{
    this.@org.gonevertical.core.client.input.richtext.workaround.RichTextAreaImpl::elem.contentWindow.document.body.innerHTML = html;
  }-*/;

  protected native void setTextImpl(String text) /*-{
    this.@org.gonevertical.core.client.input.richtext.workaround.RichTextAreaImpl::elem.contentWindow.document.body.textContent = text;
  }-*/;
  ...
  native void execCommandAssumingFocus(String cmd, String param) /*-{
    this.@org.gonevertical.core.client.input.richtext.workaround.RichTextAreaImpl::elem.contentWindow.document.execCommand(cmd, false, param);
  }-*/;
  ...
  native boolean queryCommandStateAssumingFocus(String cmd) /*-{
    return !!this.@org.gonevertical.core.client.input.richtext.workaround.RichTextAreaImpl::elem.contentWindow.document.queryCommandState(cmd);
  }-*/;
  ...
  native String queryCommandValueAssumingFocus(String cmd) /*-{
    return this.@org.gonevertical.core.client.input.richtext.workaround.RichTextAreaImpl::elem.contentWindow.document.queryCommandValue(cmd);
  }-*/;
}
