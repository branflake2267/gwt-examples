...
public class EditWiseTextBox extends Composite {

  private WiseTextBox rta = new WiseTextBox();
  
  private HTML htmlEdit = new HTML();
  
  public EditWiseTextBox(EventBus eventBus) {
