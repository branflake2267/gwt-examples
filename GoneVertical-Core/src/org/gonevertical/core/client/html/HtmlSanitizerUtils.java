...
public class HtmlSanitizerUtils implements HtmlSanitizer {

  private static final HtmlSanitizerUtils INSTANCE = new HtmlSanitizerUtils();
   ...
   * @return the instance
   */
  public static HtmlSanitizerUtils getInstance() {
    return INSTANCE;
  }
