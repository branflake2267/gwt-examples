...
public class MySqlColumnLib implements ColumnLib {
  ...
  private static final Logger log = LoggerFactory.getLogger(MySqlColumnLib.class);

  public MySqlColumnLib() {
  }
  ...
  public String createSqlColumnSyntax(ColumnData columnData) {
    ...
    case BOOLEAN:
      columnType = "BOOLEAN DEFAULT NULL";
      break;
    ...
    case INTEGER:
      if (charLength <= 2) {
        columnType = "TINYINT DEFAULT NULL"; 
      } else if (charLength <= 8) {
        columnType = "INTEGER DEFAULT NULL"; 
      } else {
        columnType = "BIGINT DEFAULT NULL";
      }
      break;
    ...
    case BLOB:
      columnType = "BLOB DEFAULT NULL";
      break;
      
    case BIGINT:
      columnType = "BIGINT(" + charLength + ") DEFAULT NULL";
      break;
      
    case TINYINT:
      columnType = "TINYINT(" + charLength + ") DEFAULT NULL";
      break;
      
    case CHAR:
      columnType = "CHAR(" + charLength + ") DEFAULT NULL";
      break;
