...
public class AppEngineUtils {
  ...
  private static final Logger log = LoggerFactory.getLogger(AppEngineUtils.class);
   ...
   * @return
   */
  public static AppEngineUtils newInstance(String username, String password, String appid) throws IOException {
    AppEngineUtils utils = new AppEngineUtils();
  ...
  public void setup(String username, String password, String appid) throws IOException {
    ...
    this.options = new RemoteApiOptions().server(appid, 443).credentials(username, password);
